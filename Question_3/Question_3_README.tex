...
of movie and shows in every country (by frequency). We then look at
which movie producing countries create the most movies, and which of
them produce the best quality movies according to ratings.
...
South Korea produces the highest quality movie on average according to
IMDB ratings.

\section{Conclusion}\label{conclusion}

The analysis has shown that History and War films, followed by
documentaries are the most-loved across the world. Furthermore, while
the United States produces the most movies/shows, it is South Korea that
produces the subjective best of them.
