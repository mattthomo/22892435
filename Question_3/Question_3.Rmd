...
To tackle this problem, we set about comparing the most popular genres of movie and shows in every country (by frequency). 
...
Figure \ref{Fig3} tells the story that while the United States has produced the most number of movies, its average rating lies below that of four countries, namely: South Korea, Japan, China, and Great Britain.
