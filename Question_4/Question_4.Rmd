...
simple_inheritance_table(US_inherited_prop, caption = "Table showing the US inheritance statistics \\label{tab1}")
```
...
simple_inheritance_table(outsideUS_inherited_prop, caption = "Table showing Outside of the US inheritance statistics \\label{tab2}")
```
